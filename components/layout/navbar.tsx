...
import { Menu, X } from "lucide-react"; // Certifique-se de ter esses ícones
    ...
    <header className="sticky top-0 z-50 w-full border-b bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/60 transition-all duration-300">
      <div className="container flex h-16 items-center justify-between px-4">
        ...
        <nav className="hidden md:flex items-center gap-6 text-sm font-medium">
          <a href="#sobre" className="hover:text-primary transition-colors hover:underline underline-offset-4">A Casa</a>
          <Link href="/doutrina" className="hover:text-primary transition-colors hover:underline underline-offset-4">Doutrina</Link>
          <Link href="/dashboard">
